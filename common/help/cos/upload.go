...
func (*Uploader) Upload(ctx context.Context, file multipart.File, userId int64, machineId uint16, videoBucket, coverBucket, SecretID, SecretKey string) (string, error) {
